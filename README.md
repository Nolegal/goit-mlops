...
```bash
# Авторизація в ECR
aws ecr get-login-password --profile nolegal --region eu-north-1 | \
...
Очікуваний вивід:
```
2026-03-15 19:00:01 INFO Received predict request with 2 instances
2026-03-15 19:00:01 INFO Input data: [[5.1, 3.5, 1.4, 0.2], [6.7, 3.1, 4.7, 1.5]]
2026-03-15 19:00:01 INFO Predictions: [0, 1], drift_detected: False
```
...
aws ecr delete-repository --repository-name inference-api --force --profile nolegal --region eu-north-1
```
